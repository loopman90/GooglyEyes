...
const skins = ["robot", "cat", "manga-female", "dragon", "tibetan-monk", "alien", "hacker"];
...
writeFileSync(join(out, "assets", "skins.json"), JSON.stringify({
  ...manifest,
  note: "Irisidian layered test package. Includes completed Robot, Cat, Manga Female, Dragon, Tibetan Monk, Alien, and Hacker skins.",
  layeredSkins: skins,
  maskSkins: skins,
  skins
}, null, 2));
...
This package includes the completed Robot, Cat, Manga Female, Dragon, Tibetan Monk, Alien, and Hacker layered skins, with runtime iris/pupil tracking, smooth CSS lids, customizable colors, and full embedded tab-panel masks.
`);
